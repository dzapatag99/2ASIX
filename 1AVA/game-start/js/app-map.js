...
document.addEventListener("DOMContentLoaded", () => {
  ...
  lGames.set(1, new Game(1, "Star Wars Jedi: Fallen Order", "Five Start Studio", "12/12/2019", "Action", "16"));
  lGames.set(2, new Game(2, "Terminator", "Marvel Studio", "12/12/2019", "Adventure", "12"));
  lGames.set(3, new Game(3, "Halo", "Pixel Studio", "12/12/2019", "Rol", "18"));
...
function addGame() {
  ...
  const nameGameFunction = (item) => item.name === document.querySelector("#game_name").value;
  if (lGames.values.some(nameGameFunction)) {
...
function deleteGame(idGame) {
  ...
  const result = lGames.values.filter(game => game.id != idGame);
  lGames = result;
...
// Util funtion to jump to a new location in the page
